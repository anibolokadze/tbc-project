...
const ProductItem: React.FC<cardProps> = ({
  ...
  return (
    <div className="flex flex-col gap-3 w-[250px] h-[370px] rounded-[10px] border border-blue-600 dark:border-light_blue overflow-hidden lg:w-[300px] lg:h-[470px] ">
      <Link href={`/products/${id}`}>
        <div className="flex flex-col gap-3 w-full h-[310px] lg:h-[390px]">
          ...
          <div className="flex flex-col gap-3 px-[18px] lg:px-[22px]">
            <h5 className="text-[15px] leading-[24px] lg:text-[18px] lg:leading-[29px] text-center text-blue-600 dark:text-light_blue">
              {title}
            </h5>
      ...
      <div className="w-full px-[35px] lg:px-[50px]">
        <button
          ...
          className="group w-full flex justify-center gap-3 items-center lg:py-2 border border-blue-600 dark:border-light_blue rounded-[10px] lg:rounded-[12px] "
        >
          <svg
